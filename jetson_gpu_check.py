...
def main():
    ...
    console.print(Panel("[bold blue]Jetson GPU Check and Optimization[/bold blue]", 
    ...
    n_gpu_layers = optimize_env_settings()
    
    # Ask to run jetson_clocks
    if console.input("\nRun jetson_clocks to maximize performance? [y/N]: ").lower() == "y":
        run_jetson_clocks()
